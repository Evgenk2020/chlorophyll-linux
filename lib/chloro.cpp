...
float final_a::get_chloro(ch_data dat) const { return (float)(dat.vol_filtrate * 0.01 * ((dat.vol_photo_probe + dat.vol_photo_alch) / dat.vol_photo_probe) * _all.get_chloro(dat) / dat.mass_of_probe); }
float final_b::get_chloro(ch_data dat) const { return (float)(dat.vol_filtrate * 0.01 * ((dat.vol_photo_probe + dat.vol_photo_alch) / dat.vol_photo_probe) * _all.get_chloro(dat) / dat.mass_of_probe); }
